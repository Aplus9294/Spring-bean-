...
<body>
	...
	<form action="<%=request.getContextPath()%>/login.do" method="post">
		<div id="language" align="left">
			<a href="<%=request.getContextPath()%>/LanguageManager?language=1">简体中文</a>
			<a href="<%=request.getContextPath()%>/LanguageManager?language=3">English</a>
		</div>
		<table>
			<tr>
			...
			<tr>
				<td align="center"><input type="submit"
					value="<%=context.getMessage("LoginPage.login", null, locale)%>" />
					<input type="reset"
					value="<%=context.getMessage("LoginPage.reset", null, locale)%>" /></td>
			</tr>
		</table>
	</form>
</body>
